  ...
  return (
    <section id="table-of-contents" className="py-8 scroll-mt-12">
      <motion.h2 
        ...
        className="text-5xl md:text-7xl text-primary-green text-center tracking-widest mb-16"
      >
        TABLE OF CONTENTS
      </motion.h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-4 md:gap-x-12 gap-y-16 max-w-6xl mx-auto">
        {[
          ...
          >
            <Link href={item.link} className="group relative flex flex-col items-center ml-4 md:ml-8 cursor-pointer transition-all duration-500 hover:-translate-y-3">
